            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                final sharedWithSnapshot = await _database
                    .ref(
                      "users/$ownerUid/pets/${widget.petId}/shared_with/$targetUid",
                    )
                    .get();
                ...
                if (sharedWithSnapshot.exists) {
                  if (context.mounted) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text("Pet is already shared with this user"),
                      ),
                    );
                  }
                  return;
                ...
                final petSnapshot = await _database
                    ...
                    .get();
                final petName =
                    petSnapshot.child("name").value?.toString() ??
                    "Unknown Pet";
                ...
                if (context.mounted) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(
                      content: Text("Share request sent to $targetEmail"),
                    ),
                  );
                }
              },
